...
const messages: Record<Locale, DictionaryTree> = {
  en: {
    ...
    forms: {
      ...
      leadSubmit: "Add lead",
      leadFormOpen: "Add new lead",
      leadFormClose: "Close form",
    ...
    clientProfile: {
      ...
      packageInvoiceLabel: "Package invoice",
      sessionDebtLabel: "Uncovered session",
      openInvoice: "Open invoice",
      hideInvoice: "Hide invoice",
      invoicePaymentHelp:
        "Record the remaining amount here when the client pays and the invoice should be closed.",
      markInvoicePaid: "Mark as paid",
      markingInvoicePaid: "Recording payment...",
      invoicePaymentFailed: "Invoice payment update failed. Please try again.",
    ...
    finance: {
      ...
      cardPaymentsDetail: "Collected via card",
      cashPayments: "Cash payments",
      cashPaymentsDetail: "Collected in cash",
      templates: "Package catalog",
      expiring: "Expiring packages",
      receivedDetail: "Payments received",
      ...
      packageInvoiceLabel: "Package invoice",
      sessionDebtLabel: "Uncovered session",
      noInvoicesForMonth: "No invoices were found for",
    },
    settings: {
  ...
  et: {
    ...
    common: {
      ...
      all: "Kõik",
      open: "Ava",
      showSection: "Ava plokk",
      hideSection: "Peida plokk",
    ...
    forms: {
      ...
      leadFormOpen: "Lisa uus lead",
      leadFormClose: "Sulge vorm",
    ...
    clientProfile: {
      ...
      packageInvoiceLabel: "Paketi arve",
      sessionDebtLabel: "Katmata treening",
      openInvoice: "Ava arve",
      hideInvoice: "Peida arve",
      invoicePaymentHelp:
        "Kui klient tasub, lisa siit puuduolev summa ja sule arve kohe ära.",
      markInvoicePaid: "Märgi makstuks",
      markingInvoicePaid: "Salvestan makset...",
      invoicePaymentFailed: "Arve makse salvestamine ebaõnnestus. Proovi uuesti.",
    ...
    finance: {
      ...
      cardPaymentsDetail: "Laekunud kaardiga",
      cashPayments: "Sularahamaksed",
      cashPaymentsDetail: "Laekunud sularahas",
      templates: "Paketikataloog",
      expiring: "Aeguvad paketid",
      receivedDetail: "Laekunud maksed",
      ...
      packageInvoiceLabel: "Paketi arve",
      sessionDebtLabel: "Katmata treening",
      noInvoicesForMonth: "Selle kuu kohta ei leitud arveid:",
    },
    settings: {
