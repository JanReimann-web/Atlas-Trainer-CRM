...
const messages: Record<Locale, DictionaryTree> = {
  en: {
    ...
    forms: {
      ...
      clientSubtitle: "Open a client profile with goals, tags, consent status, and coaching notes.",
      clientSubmit: "Create client",
      purchaseTitle: "Record package purchase",
      purchaseSubtitle: "Create the prepaid package, invoice, and payment status from one place.",
      purchaseSubmit: "Add purchase",
      assessmentTitle: "Record body assessment",
      assessmentSubtitle: "Save fresh measurements directly to the client timeline for later AI use.",
    ...
    clientProfile: {
      ...
      workoutSectionSubtitle:
        "Manage the active workout block here, then add upcoming sessions or log historical workouts without leaving the client profile.",
      ...
      noWorkoutHistory:
        "No workouts have been logged for this client yet. Add a planned or historical workout from the form on the right.",
  ...
  et: {
    ...
    forms: {
      ...
      clientSubtitle: "Ava kliendiprofiil eesmärkide, siltide, nõusoleku staatuse ja treeneri märkustega.",
      clientSubmit: "Loo klient",
      purchaseTitle: "Lisa paketiost",
      purchaseSubtitle: "Loo ettemakstud pakett, arve ja makse staatus ühest kohast.",
      purchaseSubmit: "Lisa ost",
      assessmentTitle: "Salvesta kehaanalüüs",
      assessmentSubtitle: "Lisa värsked mõõtmised otse kliendi ajalukku, et AI saaks neid hiljem kasutada.",
    ...
    clientProfile: {
      ...
      workoutSectionSubtitle:
        "Halda siin aktiivset treeninguplokki ning lisa tulevasi või ajaloolisi treeninguid otse kliendiprofiilist.",
      ...
      noWorkoutHistory:
        "Selle kliendi jaoks pole veel ühtegi treeningut logitud. Lisa paremalt uus planeeritud või ajalooline treening.",
